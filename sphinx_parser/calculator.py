...
from ase.calculators.calculator import FileIOCalculator, StandardProfile, FileIORules
...
class SphinxDft(FileIOCalculator):
    ...
    def write_input(self, atoms, properties=None, system_changes=None):
        ...
        struct_group, spin_lst = get_structure_group(atoms)
        main_group = sphinx.main(scfDiag=sphinx.main.scfDiag(maxSteps=10, blockCCG={}), evalForces=sphinx.main.evalForces('forces.txt'))
